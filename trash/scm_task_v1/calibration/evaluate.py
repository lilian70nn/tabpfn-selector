...
def _extract_sampled_parameters(task_results):
    parameter_names = (
        ...
        "sampled_edge_weight_concentration",
        "sampled_latent_noise_scale",
        "sampled_observation_type_probs",
        "sampled_edge_family_probs",
        "sampled_child_method_probs",
    )
...
def evaluate_prior(prior, n_tasks=300, num_classes=3, probe_epochs=100, real_reference=None, real_scales=None, seed_offset=0, keep_task_results=False):
    ...
    for task_index in range(n_tasks):
        ...
        result["sampled_parameters"] = {
            ...
            "sampled_edge_weight_concentration": _to_python_value(info.get("sampled_edge_weight_concentration")),
            ...
            "sampled_edge_family_probs": _to_python_value(info.get("sampled_edge_family_probs")),
            "sampled_child_method_probs": _to_python_value(info.get("sampled_child_method_probs")),
        }
