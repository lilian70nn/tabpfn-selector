...
train_synthetic(
    ...
    val_every=500,
    val_batches=50,
    save_path="/dss/dsshome1/07/ra58bim2/pfn_exp/outputs/large_synth_cls_2to2_512maxn_batch12_missing5_pred_only_log.txt",
    best_ckpt_path = "/dss/dsshome1/07/ra58bim2/pfn_exp/outputs/large_synth_cls_2to2_512maxn_batch12_missing5_pred_only_best_ckpt.pt"
)
...
train_synthetic(
    ...
    val_every=500,
    val_batches=50,
    save_path="/dss/dsshome1/07/ra58bim2/pfn_exp/outputs/large_synth_cls_2to2_512maxn_batch12_missing5_pred_imp_log.txt",
    best_ckpt_path = "/dss/dsshome1/07/ra58bim2/pfn_exp/outputs/large_synth_cls_2to2_512maxn_batch12_missing5_pred_imp_best_ckpt.pt"
)
